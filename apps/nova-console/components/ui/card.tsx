...
const baseClass = 'rounded-2xl border border-[#431D21] bg-[#050109]/90 text-[#F5E5ED] shadow-[0_12px_48px_rgba(0,0,0,0.55)]';
...
const CardDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => (
    <p ref={ref} className={cn('text-sm text-[#6faab1]', className)} {...props} />
  ),
);
