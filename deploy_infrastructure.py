...
class NovaOSDeployer:
    ...
    def check_do_droplet_status(self) -> Dict:
        ...
        response = requests.get("https://api.digitalocean.com/v2/droplets", headers=self.do_headers)
    ...
    def create_dns_records(self, zone_id: str) -> bool:
        ...
        for subdomain in self.subdomains:
            ...
            records_to_create.append(
                {"name": subdomain_name, "type": "A", "content": self.droplet_ip}
            )
    ...
    def setup_firewall_rules(self) -> bool:
        ...
        response = requests.get(
            "https://api.digitalocean.com/v2/firewalls", headers=self.do_headers
        )
    ...
    def deploy_to_server(self) -> bool:
        ...
        for cmd in commands:
            ...
            result = subprocess.run(
                ["ssh", "root@159.223.15.214", cmd], capture_output=True, text=True
            )
